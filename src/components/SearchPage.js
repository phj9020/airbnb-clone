    ...
    <div className="searhPage">
      <div className="searchPage__info">
        ...
        <SearchResult
          ...
          description="2 guests · Studio · 1 bed · 1 private bath · Wifi · Pool · Kitchen"
          star={4.95}
          price="$110"
          total="$220"
        />
        <SearchResult
          ...
          description="4 guests · Studio · 2 beds · 1 bath · Pool · Free parking · Wifi"
          star={4.52}
          price="$200"
          total="$400"
        />
        <SearchResult
          ...
          description="1 guest · 1 bedroom · 1 bed · 1 shared bath"
          star={5.0}
          price="$46"
          total="$92"
        />
        <SearchResult
          ...
          description="Free Parking · Wifi · Air Conditioning 3 guests · 1 bedroom · 1 bed · 1 shared bath"
          star={5.0}
          price="$47"
          total="$94"
        />
        <SearchResult
          ...
          location="Private room in Sanford"
          description="Wifi · Air Conditioning · 4 guests · 1 bedroom · 2 beds · 1 bath"
          star={5.0}
          price="$160"
          total="$320"
        />
        <SearchResult
          ...
          description="Wifi · Air Conditioning · 2 guests · 1 bed · 1 bath"
          star={4.99}
          price="$138"
          total="$276"
        />
